...
**On session start:**
1. `search_memories('ClaudeMailbox')` — check for pending messages
2. Act on any `[pending]` items addressed to you
3. After applying, add observation: `[source] [date] DONE: what was applied`
