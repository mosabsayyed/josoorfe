...
function InterventionPlanning({ context, onClearContext }: InterventionPlanningProps) {
  ...
  const ganttColumns = [
    { id: 'text', header: t('josoor.planning.ganttTask'), flexgrow: 1, resize: true },
    { id: 'owner', header: t('josoor.planning.ganttOwner'), width: 120, align: 'center' as const, resize: true },
    { id: 'start', header: t('josoor.planning.ganttStart'), align: 'center' as const, resize: true },
    { id: 'duration', header: t('josoor.planning.ganttDuration'), width: 80, align: 'center' as const, resize: true },
  ];
