  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "bg-muted relative grow overflow-hidden data-[orientation=horizontal]:h-4 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5",
        )}
      >
