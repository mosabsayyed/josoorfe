      ...
      <div className="observability-tabs" style={{ 
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderBottom: activeTab === 'traces' ? '2px solid var(--component-text-accent, #FFD700)' : '2px solid transparent',
            color: activeTab === 'traces' ? 'var(--component-text-accent, #FFD700)' : 'var(--component-text-secondary, #D1D5DB)',
            cursor: 'pointer',
            fontSize: '0.95rem',
            fontWeight: 600,
            transition: 'all 0.2s',
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderBottom: activeTab === 'analytics' ? '2px solid var(--component-text-accent, #FFD700)' : '2px solid transparent',
            color: activeTab === 'analytics' ? 'var(--component-text-accent, #FFD700)' : 'var(--component-text-secondary, #D1D5DB)',
            cursor: 'pointer',
            fontSize: '0.95rem',
            fontWeight: 600,
            transition: 'all 0.2s',
