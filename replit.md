...
## CURRENT PROJECT: Frontend Re-Wiring - PHASE 2 COMPLETE (STITCH Corrected)

**Status:** Phase 2 (Core Layout & Chat Integration) COMPLETE with STITCH approach. Moving to Phase 3 (Desk Components & API wiring).

### Phase 2 Completed (Jan 12, 2026) - STITCH Implementation
- [x] T00: Stashed existing /main to /main_stash
- [x] T01-T02: Created MainAppPage.tsx - uses FrameHeader directly from josoor-sandbox (not recreated)
- [x] T03-T04: Integrated New Chat button and sidebar collapse toggle
- [x] T05-T06: MainAppContext handles all conversation state (following ChatAppPage pattern)
- [x] Modified FrameHeader.tsx: added onOnboardingReplay prop, ? button, id="main-header", id="header-profile"
- [x] MainSidebar combines navigation menu + chat elements using useMainApp() context
- [x] Onboarding tour with driver.js (9 steps with navigation guards)
- [x] Removed unused MainHeader.tsx to prevent divergence
